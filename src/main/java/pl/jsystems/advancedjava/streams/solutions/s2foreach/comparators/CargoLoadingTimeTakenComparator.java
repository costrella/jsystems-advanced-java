package pl.jsystems.advancedjava.streams.solutions.s2foreach.comparators;

import pl.jsystems.advancedjava.streams.solutions.s2foreach.contents.CargoLoadingMessageContent;
