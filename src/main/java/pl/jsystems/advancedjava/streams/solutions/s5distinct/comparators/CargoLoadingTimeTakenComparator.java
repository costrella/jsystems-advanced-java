package pl.jsystems.advancedjava.streams.solutions.s5distinct.comparators;

import pl.jsystems.advancedjava.streams.solutions.s5distinct.contents.CargoLoadingMessageContent;
