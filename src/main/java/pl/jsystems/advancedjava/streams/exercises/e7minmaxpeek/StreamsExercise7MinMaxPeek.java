...
import pl.jsystems.advancedjava.streams.exercises.e7minmaxpeek.contents.CargoLoadedMessageContent;
import pl.jsystems.advancedjava.streams.exercises.e7minmaxpeek.message.Message;
import pl.jsystems.advancedjava.streams.exercises.e7minmaxpeek.receivers.CargoLoadedMessageReceiver;
import pl.jsystems.advancedjava.streams.exercises.e7minmaxpeek.receivers.CargoUnloadedMessageReceiver;
import pl.jsystems.advancedjava.streams.exercises.e7minmaxpeek.receivers.GPSTrackingMessageReceiver;
import pl.jsystems.advancedjava.streams.exercises.e7minmaxpeek.repositories.CargoLoadedMessageRepository;
