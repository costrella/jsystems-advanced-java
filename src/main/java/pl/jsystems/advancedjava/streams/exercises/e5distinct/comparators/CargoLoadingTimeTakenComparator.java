package pl.jsystems.advancedjava.streams.exercises.e5distinct.comparators;

import pl.jsystems.advancedjava.streams.exercises.e5distinct.contents.CargoLoadingMessageContent;
