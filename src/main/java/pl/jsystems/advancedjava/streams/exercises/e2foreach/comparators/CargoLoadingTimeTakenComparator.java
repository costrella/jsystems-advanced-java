package pl.jsystems.advancedjava.streams.exercises.e2foreach.comparators;

import pl.jsystems.advancedjava.streams.exercises.e2foreach.contents.CargoLoadingMessageContent;
