...
class CargoUnloadedMessageContent implements VehicleMessageContent, CargoLoadingMessageContent
{
    ...
    CargoUnloadedMessageContent(BigDecimal cargoLoadInKgs, Long loadingTimeTakenInSeconds)
    {
