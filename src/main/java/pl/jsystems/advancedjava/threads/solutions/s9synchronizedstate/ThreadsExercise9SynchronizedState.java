...
import pl.jsystems.advancedjava.threads.solutions.s9synchronizedstate.contents.CargoLoadedMessageContent;
...
import pl.jsystems.advancedjava.threads.solutions.s9synchronizedstate.receivers.CargoLoadedMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s9synchronizedstate.receivers.CargoUnloadedMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s9synchronizedstate.receivers.GPSTrackingMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s9synchronizedstate.repositories.CargoLoadedMessageRepository;
import pl.jsystems.advancedjava.threads.solutions.s9synchronizedstate.repositories.CargoUnloadedMessageRepository;
import pl.jsystems.advancedjava.threads.solutions.s9synchronizedstate.repositories.GPSTrackingMessageRepository;
...
class ThreadsExercise9SynchronizedState
{
    private static final Logger LOGGER = LoggerFactory.getLogger(ThreadsExercise9SynchronizedState.class);
    ...
    {
        new ThreadsExercise9SynchronizedState().run();
    }
