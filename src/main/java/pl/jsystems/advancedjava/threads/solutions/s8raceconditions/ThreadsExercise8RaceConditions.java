...
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.contents.CargoUnloadedMessageContent;
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.contents.GPSTrackingMessageContent;
...
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.receivers.CargoLoadedMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.receivers.CargoUnloadedMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.receivers.GPSTrackingMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.repositories.CargoLoadedMessageRepository;
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.repositories.CargoUnloadedMessageRepository;
import pl.jsystems.advancedjava.threads.solutions.s8raceconditions.repositories.GPSTrackingMessageRepository;
...
class ThreadsExercise8RaceConditions
{
    private static final Logger LOGGER = LoggerFactory.getLogger(ThreadsExercise8RaceConditions.class);
    ...
    {
        new ThreadsExercise8RaceConditions().run();
    }
