...
import pl.jsystems.advancedjava.threads.solutions.s13future.contents.CargoLoadedMessageContent;
...
import pl.jsystems.advancedjava.threads.solutions.s13future.receivers.CargoLoadedMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s13future.receivers.CargoUnloadedMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s13future.receivers.GPSTrackingMessageReceiver;
import pl.jsystems.advancedjava.threads.solutions.s13future.repositories.CargoLoadedMessageRepository;
import pl.jsystems.advancedjava.threads.solutions.s13future.repositories.CargoUnloadedMessageRepository;
import pl.jsystems.advancedjava.threads.solutions.s13future.repositories.GPSTrackingMessageRepository;
...
class ThreadsExercise13Future
{
    ...
    private Future<Integer> receiveAndStore(ExecutorService executors, MessageLogger messageLogger)
    {
        ...
        Future<Integer> itWillEnd = executors.submit(waitForAllToFinishRunnable());
        return itWillEnd;
    }
