...
import pl.jsystems.advancedjava.threads.exercises.e1creatingthreads.receivers.CargoLoadedMessageReceiver;
import pl.jsystems.advancedjava.threads.exercises.e1creatingthreads.receivers.CargoUnloadedMessageReceiver;
import pl.jsystems.advancedjava.threads.exercises.e1creatingthreads.receivers.GPSTrackingMessageReceiver;
import pl.jsystems.advancedjava.threads.exercises.e1creatingthreads.repositories.CargoLoadedMessageRepository;
import pl.jsystems.advancedjava.threads.exercises.e1creatingthreads.repositories.CargoUnloadedMessageRepository;
import pl.jsystems.advancedjava.threads.exercises.e1creatingthreads.repositories.GPSTrackingMessageRepository;
