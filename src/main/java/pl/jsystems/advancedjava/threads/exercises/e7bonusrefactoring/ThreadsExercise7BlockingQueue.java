...
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.contents.CargoLoadedMessageContent;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.contents.CargoUnloadedMessageContent;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.contents.GPSTrackingMessageContent;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.message.Message;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.receivers.CargoLoadedMessageReceiver;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.receivers.CargoUnloadedMessageReceiver;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.receivers.GPSTrackingMessageReceiver;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.repositories.CargoLoadedMessageRepository;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.repositories.CargoUnloadedMessageRepository;
import pl.jsystems.advancedjava.threads.exercises.e7bonusrefactoring.repositories.GPSTrackingMessageRepository;
