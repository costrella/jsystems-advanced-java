package pl.jsystems.advancedjava.threads.examples.e3sleepandinterruption;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

class ThreadsExample3SleepAndInterruption
{
    private static final Logger LOGGER = LoggerFactory.getLogger(ThreadsExample3SleepAndInterruption.class);

    public static void main(String[] args)
    {
        new ThreadsExample3SleepAndInterruption().run();
    }
