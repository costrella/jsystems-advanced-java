...
class LambdasExercise12InlineLambda
{
    ...
    public static void main(String[] args)
    {
        ...
        // todo - make it work
/*
        TriPredicateBufferedFilter<String> printJoinedIfEqualFilter = new TriPredicateBufferedFilter<>(areAllEqual, notBlankPrinter);
        ...
        TriPredicateBufferedFilter<Integer> printHashcodeIfSorted = new TriPredicateBufferedFilter<>(checkIfSortedAscending, simpleHashCodePrinter);
