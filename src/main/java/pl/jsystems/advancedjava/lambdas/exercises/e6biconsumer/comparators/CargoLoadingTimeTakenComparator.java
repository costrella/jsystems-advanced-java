package pl.jsystems.advancedjava.lambdas.exercises.e6biconsumer.comparators;

import pl.jsystems.advancedjava.lambdas.exercises.e6biconsumer.contents.CargoLoadingMessageContent;
