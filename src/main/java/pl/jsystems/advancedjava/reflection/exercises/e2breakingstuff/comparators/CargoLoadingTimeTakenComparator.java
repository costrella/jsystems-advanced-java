package pl.jsystems.advancedjava.reflection.exercises.e2breakingstuff.comparators;

import pl.jsystems.advancedjava.reflection.exercises.e2breakingstuff.contents.CargoLoadingMessageContent;
