...
class ReflectionExercise4ReadFromFile
{
    ...
    private static final List<String> classNames = List.of(
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.MessageLogger",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.message.MessageCreator",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.LogisticsMessagesApp",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.receivers.CargoLoadedMessageReceiver",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.receivers.CargoUnloadedMessageReceiver",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.receivers.GPSTrackingMessageReceiver",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.repositories.CargoLoadedMessageRepository",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.repositories.CargoUnloadedMessageRepository",
            "pl.jsystems.advancedjava.reflection.exercises.e4readfromfile.repositories.GPSTrackingMessageRepository"
    );

    public static void main(String[] args)
    {
        new ReflectionExercise4ReadFromFile().run();
    }
