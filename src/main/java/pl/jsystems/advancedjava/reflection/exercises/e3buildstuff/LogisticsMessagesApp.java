...
import pl.jsystems.advancedjava.reflection.exercises.e3buildstuff.contents.GPSTrackingMessageContent;
...
import pl.jsystems.advancedjava.reflection.exercises.e3buildstuff.receivers.CargoLoadedMessageReceiver;
import pl.jsystems.advancedjava.reflection.exercises.e3buildstuff.receivers.CargoUnloadedMessageReceiver;
import pl.jsystems.advancedjava.reflection.exercises.e3buildstuff.receivers.GPSTrackingMessageReceiver;
import pl.jsystems.advancedjava.reflection.exercises.e3buildstuff.repositories.CargoLoadedMessageRepository;
import pl.jsystems.advancedjava.reflection.exercises.e3buildstuff.repositories.CargoUnloadedMessageRepository;
import pl.jsystems.advancedjava.reflection.exercises.e3buildstuff.repositories.GPSTrackingMessageRepository;
...
class LogisticsMessagesApp
{
    ...
    LogisticsMessagesApp(MessageLogger messageLogger)
    {
