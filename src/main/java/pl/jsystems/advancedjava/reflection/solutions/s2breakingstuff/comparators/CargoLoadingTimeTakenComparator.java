package pl.jsystems.advancedjava.reflection.solutions.s2breakingstuff.comparators;

import pl.jsystems.advancedjava.reflection.solutions.s2breakingstuff.contents.CargoLoadingMessageContent;
